...
parser.add_argument('--dataset_dir', default='./StanfordDogs')
...
parser.add_argument('--episode_test_num', type=int, default=1000, help='how many times of the testing, testing every 10000 episodes')
...
# omit the data name, it means nothing here.. 
